...
import edu.fiuba.algo3.modelo.Edificio.EdificiosEspeciales.Banco;
...
public class TestsJuego {
    ...
    public void test01CasoDeUso1ElLadronRobaUnTesoroNacionalDeMontrealSospechosoFemeninoYDetectiveNovatoEncuentraPistaEnUnBanco() throws IOException {
        ...
        IEdificio banco = (IEdificio) new Banco("Banco de Montreal"); //En vez de usar un campo true podria settearse con Strategy el comportamiento de un Edificio para que muestre una pista o no
