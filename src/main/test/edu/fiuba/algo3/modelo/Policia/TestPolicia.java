...
public class TestPolicia {
    ...
    @Test
    public void recibirUnaAcuchilladaCambiaHorasQueAvanza() throws PoliciaException, CalendarioException {

        Calendario calendario = new Calendario();
        Calendario calendario_mock = mock(Calendario.class);
        Policia policia = new Policia("Agus", 0, calendario);
        policia.avanzarHorasCuchillada(calendario_mock);

        policia.recibirCuchillada();

        policia.avanzarHorasCuchillada(calendario_mock);
        verify(calendario_mock).avanzarHoras(1);
        verify(calendario_mock).avanzarHoras(2);
    }
}
